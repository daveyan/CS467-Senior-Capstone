...
public:
    ...
    vector<string> actions = {"pick", "pick up", "snag", "lift", "scoop", "grab", "inspect", "check", "read", "open", "take", "look", "Look"};
    ...
    bool checkForMatch(vector<string> collection1, string userInput);
